                    ...
                    return (
                        <>      
                            <Row style={{ marginBottom: '10px'}}>
                                <Col span={6} style={{ lineHeight: '32px'}} ><Text strong>식재료</Text></Col>
                                <Col span={14} style={{ lineHeight: '32px'}} >
                                    <InputNumber className="recipe-serving" min={1} max={10} step ={1} defaultValue={2} />&nbsp;<span>인분 기준</span></Col>
